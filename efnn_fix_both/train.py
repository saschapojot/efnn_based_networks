...
if (len(sys.argv)!=4):
    ...
    print("example: python ./data_directory num_epochs num_neurons")
    exit(argErrCode)
...
in_pkl_train_file=data_dir+f"/train_dataset_eps{eps}.pkl"
...
torch.save(model.state_dict(), data_dir + f"/model_weights_eps{eps}.pth")